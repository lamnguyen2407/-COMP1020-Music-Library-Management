...
public class AlbumViewController {
    ...
    // ── Setter: album data ─────────────────────────────────────────────────────
    public void setAlbumData(String albumName, String artist, String genre,
    ...
    private HBox buildRow(Song song, int index) {
        ...
        plusBtn.setOnAction(e ->
            dropdown.show(plusBtn, plusBtn.localToScreen(0, plusBtn.getHeight()).getX(),
        ...
        row.setOnMouseEntered(e -> row.setStyle(
            "-fx-padding: 10 40 10 40; -fx-border-color: #f0ebe5; " +
